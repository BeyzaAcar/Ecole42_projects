...
int main() {
    ...
    printf("\nplease enter the nominator of the first number");
    scanf("%d", &num1);
    printf("\nplease enter the denominator of the first number");    
    scanf("%d", &den1);
    printf("\nplease enter the nominator of the second number");
    scanf("%d", &num2);
    printf("\nplease enter the denominator of the second number");
    scanf("%d", &den2);
